...
**Миграции не были идемпотентными** - добавил `IF NOT EXISTS` везде

**Несоответствие имён колонок** - привёл к единой схеме (`user_id`, `team_name`, `pull_request_id`)

**Несуществующий user в seed-данных** - исправил ссылки на пользователей
